<template>
  <ul id="order-items-list">
    <OrderListItem v-for="(drink, index) in order" :key="index" :index="index" :data-index="index" :size="drink.size" :tea="drink.tea" :milk="drink.milk" :topping="drink.topping" :ice="drink.ice" :sugar="drink.sugar" :fillColor="index % 3" :price="drink.price" @remove="removeDrink(index)" @duplicate="duplicateDrink(index)" @change="changeDrink" />
